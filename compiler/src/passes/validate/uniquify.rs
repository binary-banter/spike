...
pub struct PrgUniquified<'p> {
    ...
    pub defs: Vec<Def<Spanned<UniqueSym<'p>>, Spanned<&'p str>, Spanned<Expr<'p, Spanned<UniqueSym<'p>>, Spanned<&'p str>>>>>,
...
// fn uniquify_def<'p>(
//     def: Def<Spanned<&'p str>, Spanned<&'p str>, Spanned<Expr<'p, &'p str>>>,
//     scope: &mut PushMap<&'p str, UniqueSym<'p>>,
// ) -> Result<Def<Spanned<UniqueSym<'p>>, Spanned<&'p str>, Spanned<Expr<'p, Spanned<UniqueSym<'p>>>>>, TypeError> {
//     // match def {
//     //     Def::Fn {
//     //         sym,
//     //         params,
