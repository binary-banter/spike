...
use crate::passes::validate::constrain::lit;
...
fn constrain_access_field<'p>(env: &mut Env<'_, 'p>, span: Span, strct: Box<Meta<Span, ExprUniquified<'p>>>, field: Meta<Span, &'p str>) -> Result<Meta<CMeta, ExprConstrained<'p>>, TypeError> {
...
fn constrain_struct<'p>(env: &mut Env<'_, 'p>, span: Span, sym: Meta<Span, UniqueSym<'p>>, fields: Vec<(Meta<Span, &'p str>, Meta<Span, ExprUniquified<'p>>)>) -> Result<Meta<CMeta, ExprConstrained<'p>>, TypeError> {
...
fn constrain_assign<'p>(env: &mut Env<'_, 'p>, span: Span, sym: Meta<Span, UniqueSym<'p>>, bnd: Box<Meta<Span, ExprUniquified<'p>>>) -> Result<Meta<CMeta, ExprConstrained<'p>>, TypeError> {
...
fn constrain_seq<'p>(env: &mut Env<'_, 'p>, span: Span, stmt: Box<Meta<Span, ExprUniquified<'p>>>, cnt: Box<Meta<Span, ExprUniquified<'p>>>) -> Result<Meta<CMeta, ExprConstrained<'p>>, TypeError> {
...
fn constrain_return<'p>(env: &mut Env<'_, 'p>, span: Span, bdy: Box<Meta<Span, ExprUniquified<'p>>>) -> Result<Meta<CMeta, ExprConstrained<'p>>, TypeError> {
...
fn constrain_continue<'p>(env: &mut Env<'_, 'p>, span: Span) -> Result<Meta<CMeta, ExprConstrained<'p>>, TypeError> {
    expect(
...
fn constrain_break<'p>(env: &mut Env<'_, 'p>, span: Span, bdy: Box<Meta<Span, ExprUniquified<'p>>>) -> Result<Meta<CMeta, ExprConstrained<'p>>, TypeError> {
...
fn constrain_loop<'p>(env: &mut Env<'_, 'p>, span: Span, bdy: Box<Meta<Span, ExprUniquified<'p>>>) -> Result<Meta<CMeta, ExprConstrained<'p>>, TypeError> {
...
fn constrain_apply<'p>(env: &mut Env<'_, 'p>, span: Span, fun: Box<Meta<Span, ExprUniquified<'p>>>, args: Vec<Meta<Span, ExprUniquified<'p>>>) -> Result<Meta<CMeta, ExprConstrained<'p>>, TypeError> {
...
fn constrain_if<'p>(env: &mut Env<'_, 'p>, span: Span, cnd: Box<Meta<Span, ExprUniquified<'p>>>, thn: Box<Meta<Span, ExprUniquified<'p>>>, els: Box<Meta<Span, ExprUniquified<'p>>>) -> Result<Meta<CMeta, ExprConstrained<'p>>, TypeError> {
...
fn constrain_let<'p>(env: &mut Env<'_, 'p>, span: Span, sym: Meta<Span, UniqueSym<'p>>, mutable: bool, typ: Option<Type<Meta<Span, UniqueSym<'p>>>>, bnd: Box<Meta<Span, ExprUniquified<'p>>>, bdy: Box<Meta<Span, ExprUniquified<'p>>>) -> Result<Meta<CMeta, ExprConstrained<'p>>, TypeError> {
    let bnd = constrain_expr(*bnd, env)?;
...
fn constrain_binary_op<'p>(env: &mut Env<'_, 'p>, span: Span, op: BinaryOp, lhs: Box<Meta<Span, ExprUniquified<'p>>>, rhs: Box<Meta<Span, ExprUniquified<'p>>>) -> Result<Meta<CMeta, ExprConstrained<'p>>, TypeError> {
...
fn constrain_unary_op<'p>(env: &mut Env<'_, 'p>, span: Span, op: UnaryOp, expr: Box<Meta<Span, ExprUniquified<'p>>>) -> Result<Meta<CMeta, ExprConstrained<'p>>, TypeError> {
    let typ = match op {
...
fn constrain_var<'p>(env: &mut Env<'_, 'p>, span: Span, sym: Meta<Span, UniqueSym<'p>>) -> Result<Meta<CMeta, ExprConstrained<'p>>, TypeError> {
