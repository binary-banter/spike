...
pub fn constrain_binary_op<'p>(env: &mut Env<'_, 'p>, span: Span, op: BinaryOp, lhs: Box<Meta<Span, ExprUniquified<'p>>>, rhs: Box<Meta<Span, ExprUniquified<'p>>>) -> Result<Meta<CMeta, ExprConstrained<'p>>, TypeError> {
