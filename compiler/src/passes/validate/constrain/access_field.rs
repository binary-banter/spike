...
pub fn constrain_access_field<'p>(env: &mut Env<'_, 'p>, span: Span, strct: Box<Meta<Span, ExprUniquified<'p>>>, field: Meta<Span, &'p str>) -> Result<Meta<CMeta, ExprConstrained<'p>>, TypeError> {
